    ...
    <footer className='pb-16 pt-10'>
      <div className='container'>
        <div className='flex justify-between flex-col md:flex-row flex-wrap gap-[30px]'>
          <div>
            <img src={logo} alt="" />
            <p className='text-[16px] leading-7 font-[400] text-textColor mt-4 inline-flex items-center'>
              Copyright <FaRegCopyright className='mx-1' size={12}/> {year} developed by Pulkit Gangil, All rights reserved.
            </p>
