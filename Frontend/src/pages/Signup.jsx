...
const Signup = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    const handleFileInputChange = async (event)=>{
      ...
      //console.log(data);
      //after console you will get the url once your upload a photo then,
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="mb-5 flex items-center justify-between">
                <label className='text-headingColor font-bold text-[16px] leading-7'>
                  Are you a:
                  <select name="role" value={formData.role} onChange={handleInputChange} id="" className='text-textColor font-semibold
                ...
                <label className='text-headingColor font-bold text-[16px] leading-7'>
                  Gender:
                  <select name="gender" value={formData.gender} onChange={handleInputChange} id="" className='text-textColor font-semibold
                  text-[15px] leading-7 px-4 py-3 focus:outline-none'>
