    ...
    <section>
      <div className="max-w-[1170px] px-5 mx-auto">
        <div className="grid md:grid-cols-3 gap[50px]">
          <div className="md:col-span-2 mr-[30px]">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className='text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis modi temporibus ea totam aliquam iste suscipit inventore soluta.</p>
              </div>
            </div>
